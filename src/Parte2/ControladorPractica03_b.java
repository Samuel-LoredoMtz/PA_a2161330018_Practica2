...
public class ControladorPractica03_b implements ActionListener {

    private Practica03_b vista;

    public ControladorPractica03_b(JFrame padre) {
        vista = new Practica03_b(padre);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (comando) {
            ...
            case "Eliminar":
                ...
                break;
            case "Salir":
                vista.barra = new Librerias().menusPadre(vista.barra, true);
                vista.dispose();
                break;
        }
    }
